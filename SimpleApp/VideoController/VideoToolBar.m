...
//  SimpleApp
//
//  Created by 崔雪瑶 on 2023/2/22.
//  视频播放页面每个视频播放画面下的一横条几个小图标
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        [self addSubview:({
            ...
            _avatorImageView.layer.maskedCorners=15;
        ...
        [self addSubview:({
            ...
            _commentImageView.layer.maskedCorners=15;
        ...
        [self addSubview:({
            ...
            _likeImageView.layer.maskedCorners=15;
        ...
        [self addSubview:({
            ...
            _shareImageView.layer.maskedCorners=15;
...
//使用autoLayout对整个toolBar进行布局
-(void)layoutWithModel:(id)model{
//    self.backgroundColor=[UIColor whiteColor];
    _avatorImageView.image=[UIImage imageNamed:@"icon.bundle/icon@2x.png"];
    _nickLabel.text=@"author";
    
    _commentImageView.image=[UIImage imageNamed:@"icon.bundle/pinglun.png"];
    _commentLabel.text=@"100";

    _likeImageView.image=[UIImage imageNamed:@"icon.bundle/dianzan.png"];
    _likeLabel.text=@"25";

    _shareImageView.image=[UIImage imageNamed:@"icon.bundle/fenxiang.png"];
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [NSLayoutConstraint constraintWithItem:_commentImageView
                                     attribute:NSLayoutAttributeHeight
                                     relatedBy:NSLayoutRelationEqual
                                        toItem:nil
                                     attribute:NSLayoutAttributeNotAnAttribute
        ...
        [NSLayoutConstraint constraintWithItem:_likeImageView
                                     attribute:NSLayoutAttributeHeight
                                     relatedBy:NSLayoutRelationEqual
                                        toItem:nil
                                     attribute:NSLayoutAttributeNotAnAttribute
        ...
        [NSLayoutConstraint constraintWithItem:_shareImageView
                                     attribute:NSLayoutAttributeHeight
                                     relatedBy:NSLayoutRelationEqual
                                        toItem:nil
                                     attribute:NSLayoutAttributeNotAnAttribute
